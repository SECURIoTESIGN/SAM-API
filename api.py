...
mysql.init_app(app)
import views.user, views.module, views.session, views.recommendation, views.question, views.answer, views.group, views.type, views.dependency, views.file # SAM's views
