...
# Please, do not store your configuration file in the github repository (just the sample one)
...
import views.authentication, views.user  
...
"""
TESTS
[Summary]: Just a test service, only authenticated users can access
